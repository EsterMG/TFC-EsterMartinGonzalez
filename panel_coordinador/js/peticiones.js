...
function filtrarFinalizadas() {
    ...
    const filtro = document.querySelector('.fin-filtro-btn.activo')?.dataset.filtro ?? 'todos';
...
function setFiltro(btn, valor) {
    document.querySelectorAll('.fin-filtro-btn').forEach(b => b.classList.remove('activo'));
